<template>
  <v-card>
    ...
    <template v-slot:top>
      <v-toolbar flat style="background-color: #9d8096">          
        <v-toolbar-title>Asignar Planta a Territorios</v-toolbar-title>
        <v-divider
          class="mx-4"
          inset
          vertical
            ...
            <v-card-text>
                <v-container>
                    ...
                    class="mb-4">
                        <p>Territorio</p>
                        <v-combobox
                        v-model="asignacionEditada.territorio"
                        :items="menuEdicion.territorio"
                        clearable
                        ></v-combobox>
                    </v-col>
...
<script>
  ...
  export default {
    ...
    data: () => ({
      ...
      dialogDelete: false,
      headers: [
        { text: 'Territorio', value: 'territorio', sortable: true, align: 'start' }, 
      ...
      indiceEditado: -1,
      menuEdicion: {
        territorio: [ "BALANCAN", "COMALCALCO", "TZUCACAB(OTHON P. BLANCO)", "PALENQUE", "PICHUCALCO", "DURANGO", "CORDOBA", "ACAYUCAN", "PAPANTLA", "OCOSINGO", "TAPACHULA", "TEAPA", "XPUJIL(CAMPECHE)", "TAMAULIPAS", "GUERRERO", "COLIMA", "SINALOA", "HIDALGO", "TANTOYUCA", "MICHOACAN", "CHIHUAHUA", "NAYARIT", "TLAXCALA", "MORELOS", "PUEBLA", "OAXACA - MIXTECA", "OAXACA - ITSMO", "SAN LUIS POTOSI"],
        abastecimiento: [
            {
                "abastecimiento": "",
                "vivero": [
