<template>
  <v-card>
    ...
    <template v-slot:top>
      <v-toolbar flat style="background-color: #9d8096">          
        <v-toolbar-title>Asignar Planta a Facilitadores</v-toolbar-title>
        <v-divider
          class="mx-4"
          inset
          vertical
            ...
            <v-card-text>
                <v-container>
                    ...
                    class="mb-4">
                        <p>Facilitador</p>
                        <v-combobox
                        v-model="asignacionEditada.facilitador"
                        :items="menuEdicion.facilitador"
                        clearable
                        ></v-combobox>
                    </v-col>
...
<script>
  ...
  export default {
    ...
    data: () => ({
      ...
      dialogDelete: false,
      headers: [
        { text: 'Facilitador', value: 'facilitador', sortable: true, align: 'start' }, 
      ...
      plantasAsignadas: [
            {
                "facilitador":"Jose Francisco Rubio",
            ...
            {
                "facilitador":"Ruben Jimenez Lopez",
            ...
            {
                "facilitador":"Erick Aguirre Garcia",
                "abastecimiento":"Vivero comercial",
            ...
            {   
                "facilitador":"Maria Lopez Zuñiga",
            ...
            {
                "facilitador":"Esteban Escamilla Escalona",
                "abastecimiento":"Vivero comercial",
            ...
            {
                "facilitador":"Luis Roberto Perez",
                "abastecimiento":"Vivero Forestal Militar",
                "vivero":"VIVERO MILITAR, CARDENAS",
                "catPlanta":"Forestal",
                "especie":"Swietenia Macrophylla (CAOBA)",
